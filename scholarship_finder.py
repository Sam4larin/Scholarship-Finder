...
with st.sidebar:
    ...
    gpa = st.number_input("Your CGPA (optional)", min_value=0.0, max_value=5.0, step=0.1)
    ...
    nationality = st.text_input("Country of Nationality (optional)")
    residence = st.text_input("Country of Residence  (optional)")
